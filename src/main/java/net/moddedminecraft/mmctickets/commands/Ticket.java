...
public class Ticket implements CommandExecutor {
    ...
    void showHelp(CommandSource sender) {
        ...
        if (sender.hasPermission(Permissions.COMMAND_TICKET_COMMENT))
